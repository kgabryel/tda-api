...
use App\Alarm\Domain\Event\Port\AlarmAttachedToTask;
...
#[ListenEvent(AlarmAttachedToTask::class)]
class AttachedToTaskHandler
{
    ...
    public function handle(AlarmAttachedToTask $event): void
    {
        $this->commandBus->handle(new UpdateTask($event->getAlarmId(), $event->getTaskId()));
    }
}
